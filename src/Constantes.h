...
namespace Constantes {
    ...
    const float BATERIA_CONSUMO_SEGUNDO = 0.5f;
    const float BATERIA_FLICKER_THRESHOLD = 30.0f;
    const float VELOCIDAD_LINTERNA = 8.0f;
...
namespace ConstantesJefe {
    ...
    const float VIDA_FASE_DOS_TRIGGER = 0.3f;
    ...
    const float TIEMPO_MAX_EMBESTIDA = 1.5f;
    ...
    // Timers fase 2
    const float VELOCIDAD_DASH_SOMBRA = 900.0f;
    const float TIEMPO_APUNTAR_SOMBRA = 1.0f;
    const float TIEMPO_DASH_SOMBRA = 0.5f;
    const float TIEMPO_PREPARAR_DISPARO_INT = 0.2f;
    const float TIEMPO_PREPARAR_LLUVIA = 0.5f;
    const float COOLDOWN_DASH_SOMBRA = 1.0f;
